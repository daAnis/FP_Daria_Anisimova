...
function Inject(key) {
    return function (target, propertyKey) {
        Object.defineProperty(target, propertyKey, {
            get: function () { return instanceMap.get(key); }
        });
    };
}
var TestInjectable = function () {
    ...
    var TestInjectable = _classThis = /** @class */ (function () {
        ...
        TestInjectable_1.prototype.getMessage = function () {
...
var TestInject = function () {
    ...
    return _a = /** @class */ (function () {
            ...
            TestInject.prototype.print = function () {
                ...
                var message = this.testedField.getMessage();
                console.log(message);
            };
            return TestInject;
        }()),
...
document.addEventListener('DOMContentLoaded', function () {
    var testInstance = new TestInject();
    testInstance.print();
    document.getElementById('testResult').textContent = "\u0420\u0435\u0437\u0443\u043B\u044C\u0442\u0430\u0442: ".concat(testInstance.testedField.getMessage());
});
